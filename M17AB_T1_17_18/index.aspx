...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="divLogin" runat="server">
        Email:<asp:TextBox CssClass="form-control" ID="TextBox1" runat="server"></asp:TextBox>
        Password:<asp:TextBox CssClass="form-control" TextMode="Password" ID="TextBox2" runat="server"></asp:TextBox>
